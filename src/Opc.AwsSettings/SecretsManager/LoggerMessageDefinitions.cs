...
public static partial class LoggerMessageDefinitions
{
    ...
    [LoggerMessage(EventId = 2, Level = LogLevel.Information, Message = "{count} secrets have been loaded from Secrets Manager")]
    ...
    [LoggerMessage(EventId = 3, Level = LogLevel.Information, Message = "SecretsManagerConfigurationProvider is disposed")]
    public static partial void SecretsManagerConfigurationProviderDisposed(this ILogger logger);

    [LoggerMessage(EventId = 4, Level = LogLevel.Error, Message = "Error retrieving secret value (Secret: {SecretName} Arn: {SecretARN})")]
    public static partial void ErrorLoadingSecret(this ILogger logger, string secretName, string secretArn, Exception exception);
}

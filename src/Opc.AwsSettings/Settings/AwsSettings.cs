...
public record AwsSettings
{
    ...
    /// <summary>
    /// Determines how to read configuration from Secrets Manager in a more flexible way than using <see cref="ParameterStore"/>
    /// </summary>
    ...
    /// </summary>
    public TimeSpan? ReloadAfter { get; init; }
}